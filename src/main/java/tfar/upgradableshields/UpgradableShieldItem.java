...
public class UpgradableShieldItem extends ShieldItem {
    ...
    public static boolean isUltimate(ItemStack shield) {
        return shield.getItem() instanceof UpgradableShieldItem && shield.hasTag() && shield.getTag().getString("highest").toLowerCase(Locale.ROOT).equals("ultimate");
    }
    ...
    public void inventoryTick(ItemStack stack, World worldIn, Entity entityIn, int itemSlot, boolean isSelected) {
        ...
        if (entityIn instanceof PlayerEntity) {
            ...
            if (!worldIn.isRemote) {
                ...
                if (stack.hasTag() && stack.getTag().getInt("dashing") > 0) {
            ...
            if (equipped(player) && isUltimate(stack)) {
    ...
    private static boolean equipped(PlayerEntity player) {
        return player.getHeldItemOffhand().getItem() instanceof UpgradableShieldItem || player.getHeldItemMainhand().getItem() instanceof UpgradableShieldItem;
    }
